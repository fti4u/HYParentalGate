...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/RomanN2/HYParentalGate.git", :tag => "1.0.19" }
  s.source_files  = "HYParentalGate/**/*.{swift}"
  s.resources = "HYParentalGate/*.{xcassets,xib}", "HYParentalGate/HYLocalization.plist"
